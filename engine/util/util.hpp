...
const char* fsweapon_string           ( fsweapon_e weapon );
const char* fsrelic_string            ( fsrelic_e relic );
const char* gem_type_string           ( gem_type_e gem );
...
SC_ENUM_FORMATTER( fsweapon_e,              util::fsweapon_string );
SC_ENUM_FORMATTER( fsrelic_e,               util::fsrelic_string );
SC_ENUM_FORMATTER( gem_type_e,              util::gem_type_string );
